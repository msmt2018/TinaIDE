...
fun GitInitDialog(
    ...
    TinaAlertDialog(
        ...
        title = { TinaDialogTitleText(stringResource(Strings.git_init_title)) },
        text = {
            TinaDialogContentColumn(
                modifier = Modifier.fillMaxWidth(),
                verticalArrangement = Arrangement.spacedBy(16.dp)
                ...
                TinaDialogCard(
                    ...
                    Text(
                        text = stringResource(Strings.git_init_message),
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
                ...
                if (isLoading) {
                    GitDialogLoadingCard(text = stringResource(Strings.git_initializing))
                }
            }
        },
        confirmButton = {

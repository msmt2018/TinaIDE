...
(class_specifier) @local.scope.members
(struct_specifier) @local.scope.members
...
; Class / struct member fields
(field_declaration
  declarator: (field_identifier) @local.definition.var)

; Enum constants (C++ grammar compatible: identifier or field_identifier)
(enumerator

...
public final class TerminalView extends View {
    ...
    /**
     * Sets the text size for rendering only, without triggering terminal resize.
     * Used during pinch-to-zoom gestures for visual feedback.
     * Call {@link #updateSize()} separately after the gesture settles.
     */
    public void setTextSizeWithoutResize(int textSize) {
        mRenderer = new TerminalRenderer(textSize, mRenderer == null ? Typeface.MONOSPACE : mRenderer.mTypeface);
        invalidate();
    }
